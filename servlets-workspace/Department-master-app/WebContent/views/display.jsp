...
out.print("<tr><th>DeptNumber</th> <th>Name</th><th>Location</th><th>Edit</th><th>Delete</th></tr>");
for(Department deptObj:Result){
	out.print("<tr><th>"+deptObj.getDeptNo()+"</th><th>"+deptObj.getdName()+"</th><th>"+deptObj.getLoc()+
			"<th><a href='http://localhost:8080/Department-master-app/edit?DeptNo="+deptObj.getDeptNo()+"'>Edit</a></th>"+
