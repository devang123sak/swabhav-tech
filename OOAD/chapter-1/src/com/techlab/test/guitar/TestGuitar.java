package com.techlab.test.guitar;
...
public class TestGuitar {
	...
	public static void main(String[] args) {
		...
		/*GuitarSpec whatErinLikes = new GuitarSpec(Builder.GIBSON, "CJ",
				Type.ACOUSTIC, 6, Wood.INDIAN_ROSEWOOD, Wood.SITKA);
*/
		GuitarSpec whatErinLikes = new GuitarSpec(Builder.GIBSON, "sg"
				+ "", Type.ELECTRIC, 6, Wood.BRAZILIAN_ROSEWOOD, Wood.MAPLE);
	...
	private static void initializeInventory(Inventory inventory) {
		...
		inventory.addGuitar("122784", 5495.95, new GuitarSpec(Builder.MARTIN,
				"D-18", Type.ACOUSTIC, 6, Wood.MAHOGANY, Wood.MAPLE));
		inventory
				.addGuitar("76531", 6295.95, new GuitarSpec(Builder.MARTIN,
		...
		inventory.addGuitar("77023", 6275.95, new GuitarSpec(Builder.MARTIN,
				"D-28", Type.ACOUSTIC, 6, Wood.BRAZILIAN_ROSEWOOD, Wood.CEDAR));
